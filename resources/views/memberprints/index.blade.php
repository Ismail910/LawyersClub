...
<body>
    <div class="container no-print">
        ...
        <div class="table-responsive">
            <table class="table" id="memberPrintTable">
                <thead>
                    <tr>
        ...
        <!-- Print Button -->
        <button id="printButton" class="btn-print">طباعة الأعضاء</button>
    </div>
    ...
    <script>
        ...
        $(document).ready(function () {
            dataTable = $('#memberPrintTable').DataTable({
        processing: true,
    ...
    function setDefaultDates() {
        ...
        function printTable() {
            // Get all rows
            const rows = $('#memberPrintTable tbody tr').get();
            ...
            printSection.append(`
                <div style="text-align: center; margin-bottom: 20px;">
                    <h2 style="margin: 0; color: #2c3e50;">كشف أعضاء الطباعة</h2>
            ...
            for (let i = 0; i < pageCount; i++) {
                ...
                // Add header
                pageTable.append($('#memberPrintTable thead').clone());
