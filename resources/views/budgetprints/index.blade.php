...
<body>
    <div class="container no-print">
        ...
        <div class="table-responsive">
            <table class="table" id="budgetPrintTable">
                <thead>
                    <tr>
        ...
        <!-- Print Button -->
        <button id="printButton" class="btn-print">طباعة الميزانية</button>
    </div>
...
function printTable() {
    ...
    for (let i = 0; i < pageCount; i++) {
        ...
        // Add header
        pageTable.append($('#budgetPrintTable thead').clone());
